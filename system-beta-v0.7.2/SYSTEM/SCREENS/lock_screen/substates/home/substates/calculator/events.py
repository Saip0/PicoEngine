...
def igual():
        ...
        if elmt["action"] == "Typ":
            ...
            try:
               ...
               #print(elmt["text"])
                ...
                texto = "Erro"
            texto_ui = elmt
            font_txt = font_sizes[texto_ui["font"]]
    ...
    text_lin = []
    chr_surf = quart_surf // font_txt[0]
    size_text = len(texto)*font_txt[0]
    #print(texto)
    #print(quart_surf)
    #print(size_text)
    while True:
        ...
        if size_text <= quart_surf or len(text_lin)*font_txt[1] > surfice["layout"]["size"][1]*0.75:
            #print("saiu")
            #len(texto) < 10 and 
            if len(text_lin*font_txt[1]) < surfice["layout"]["size"][1]*0.75:
    ...
    texto_ui["layout"]["pos"] = [[0,i*font_txt[1]] for i in range(len(text_lin))]
    #print(texto_ui["lin"])
